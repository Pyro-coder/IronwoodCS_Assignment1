...
For this assignment, you need to help construct a calculator. Four functions were left unfinished, and it is up to you to complete them. These functins are:
1. add()
2. subtract()
3. multiply()
4. divide()
